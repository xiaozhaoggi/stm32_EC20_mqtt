...
#define imu901_uart_receive(data, len)	usart1_getRxData(data, len) /*!< 串口获取接收数据API */
#define imu901_uart_send(data, len)			USART1_Write(USART1, data, len);/*!< 串口i发送数据API */
